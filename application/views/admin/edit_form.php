			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					...
					<div class="card-body">
						...
						<form action="<?php echo site_url('admin/edit/'.$materi->id)?>" method="post" enctype="multipart/form-data" >
							<div class="form-group">
								<label for="name">Judul Materi*</label>
								<input class="form-control <?php echo form_error('judul_materi') ? 'is-invalid':'' ?>"
								 type="text" name="judul_materi" value="<?php echo $materi->judul_materi;?>" placeholder="Product name" autocomplete="off"/>
							...
							<div class="form-group">
								...
								<textarea class="form-control <?php echo form_error('isi_materi') ? 'is-invalid':'' ?>"
								 name="isi_materi" placeholder="Isi Materi..." autocomplete="off"><?php echo $materi->isi_materi; ?></textarea>
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('link_youtube') ? 'is-invalid':'' ?>"
								 type="text" name="link_youtube" min="0" value="<?php echo $materi->link_youtube; ?>" placeholder="Link Embed Youtube" />
								<div class="invalid-feedback">
